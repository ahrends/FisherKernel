function [hmm,Gamma,Xi,vpath,LL,datat] = hmmdual_FK(data,T,hmm,Gamma,Xi,residuals)
%
...
if isempty(Gamma)   
[Gamma,~,Xi,LL] = hsinference(data,T,hmm,residuals); % need Xi for gradient
if isempty(Xi) 
...
% for use with gradient:
datat = data; % save transformed data as output
% Tt = T; % save transformed T as output
